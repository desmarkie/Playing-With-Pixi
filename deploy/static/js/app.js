...
var App, Dots, InfoPanel, MathUtils, Node, PWPData, SineWave, Sketch, Smoky, Spirals, Trails,
...
App = (function() {
  ...
  App.prototype.updateInfoContent = function() {
    ...
    this.currentButton.innerHTML = '<h1>' + this.sketches[this.currentSketch].id + '</h1><div id="current-sketch-content">' + this.getSketchCopy() + '</div>';
    this.prevButton.innerHTML = '<h1>' + this.sketches[prevId].id + '</h1>';
    this.nextButton.innerHTML = '<h1>' + this.sketches[nextId].id + '</h1>';
    return null;
  };
  ...
  App.prototype.getSketchCopy = function() {
    var str;
    str = "<p class='information-panel-copy'>" + this.data[this.currentSketch].instructions + "</p>";
    str += "<p class='information-panel-copy'>" + this.data[this.currentSketch].description + "</p>";
    return str;
  };
