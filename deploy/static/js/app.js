...
var App, Dots, MathUtils, Node, Sketch, Smoky, Trails,
...
Dots = (function(_super) {
  ...
  Dots.prototype.load = function() {
    var _this = this;
    if (!this.loaded) {
      this.stage = new PIXI.Stage(0x3d3e3e);
      this.createSprites();
      ...
      this.gui.add(this, 'spriteSize', 16, 128).onFinishChange(function(val) {
...
App = (function() {
  ...
  App.prototype.handleInterfaceOut = function(e) {
    if (this.menuOpen && e.target !== this.menuButton) {
      TweenMax.to(e.target, 2, {
        css: {
          color: '#e3e3e3'
        },
    ...
    } else if (this.infoOpen && e.target !== this.infoButton) {
      TweenMax.to(e.target, 2, {
        css: {
          color: '#e3e3e3'
        },
