...
var App, CometParticle, CometSparkParticle, Comets, Dots, Fractals, InfoPanel, MathUtils, Menu, MenuButton, Node, Orbits, PWPData, Plankton, PlanktonTank, Point, Radar, Ribbon, SineWave, Sketch, Smoky, Spirals, Stacks, Trails,
  ...
  Comets.prototype.drawPaths = function() {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      for (i = _j = 0, _ref1 = comet.positions.length - 2; 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1; i = 0 <= _ref1 ? ++_j : --_j) {
        this.graphics.lineStyle(1, 0xd0d0ff, (i * inc) * (comet.life / comet.totalLife));
...
Plankton = (function(_super) {
  ...
  function Plankton() {
    ...
    this.gut.tint = Math.random() * 0xFFFFFF;
  ...
  Plankton.prototype.update = function() {
    ...
    if (this.tailProps.dir === 1) {
      sin = Math.sin(this.angle * this.degToRad);
      cos = Math.cos(this.angle * this.degToRad);
    ...
    this.view.position.x = this.position.x;
    this.view.position.y = this.position.y;
    this.view.rotation = (this.angle + 180) * this.degToRad;
    return null;
  };
  ...
  Plankton.prototype.updateTail = function() {
    ...
    this.tail.position.y = this.tailProps.dist;
    sin = Math.sin(30 * this.degToRad);
    cos = Math.cos(30 * this.degToRad);
