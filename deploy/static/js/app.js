...
var App, Dots, InfoPanel, MathUtils, Menu, MenuButton, Node, PWPData, SineWave, Sketch, Smoky, Spirals, Trails,
...
Menu = (function() {
  ...
  Menu.prototype.updateInfoContent = function() {
    ...
    this.currentButton.innerHTML = '<h1>' + this.data[this.app.currentSketch].classId + '</h1><div id="current-sketch-content">' + this.getSketchCopy() + '</div>';
    _ref = this.buttons;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      but = _ref[_i];
  ...
  Menu.prototype.getSketchCopy = function() {
    var str;
    str = "<p class='information-panel-copy'>" + this.data[this.app.currentSketch].instructions + "</p>";
    str += "<p class='information-panel-copy'>" + this.data[this.app.currentSketch].description + "</p>";
    return str;
  };
