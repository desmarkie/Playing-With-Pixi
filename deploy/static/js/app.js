...
var App, ColourConversion, CometParticle, CometSparkParticle, Comets, Dots, Fractals, InfoPanel, MathUtils, Menu, MenuButton, Node, Orbits, PWPData, PictureTile, Plankton, PlanktonTank, Point, Radar, Ribbon, ShapeShifter, SineWave, Sketch, Smoky, Spirals, Spirograph, SpirographNode, SquidNode, Squids, Stacks, Timer, Trails,
...
Timer = (function() {
  function Timer(startDate, precision, autoStart) {
    this.startDate = startDate != null ? startDate : null;
    this.precision = precision != null ? precision : 100;
    if (autoStart == null) {
      autoStart = false;
    }
    this.start = __bind(this.start, this);
    this.reset = __bind(this.reset, this);
    this.elapsed = __bind(this.elapsed, this);
    this.reset();
    if (autoStart) {
      this.start();
    }
  ...
  Timer.prototype.reset = function() {
    this.start = this.time = new Date(this.startDate).valueOf();
    return null;
  };
  ...
  Timer.prototype.start = function() {
    ...
    setInterval(function() {
      return _this.time += _this.precision;
    }, this.precision);
    return null;
  };
