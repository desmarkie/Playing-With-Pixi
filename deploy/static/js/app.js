...
var App, Dots, InfoPanel, MathUtils, Node, Sketch, Smoky, Spirals, Trails,
...
InfoPanel = (function() {
  ...
  InfoPanel.prototype.resize = function() {
    ...
    $(this.contentPanel).css('top', yPos + 'px');
    $(this.contentPanel).css('left', xPos + 'px');
    return null;
  };
...
App = (function() {
  ...
  function App() {
    ...
    window.onresize = function() {
      var sketch, _j, _len1, _ref, _results;
